...
// Power save biases the driver's RSSI ~12dB low (-70 measured reads as -82),
// so the shared cutoffs show a bar too few. Single point calibration.
SignalThresholds PLAT_signalThresholds(void) { return (SignalThresholds){ -72, -82 }; }
